...
import com.smhrd.projectweb.entity.request.api.v1.timelapse.TimelapseRequest;
import com.smhrd.projectweb.entity.response.api.v1.timelapse.TimelapseResponse;
...
@RequestMapping("/api/v1/timelapse/{deviceId}")
@RestController
